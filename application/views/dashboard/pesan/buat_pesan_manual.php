                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default">
                                <form role="form" method="POST" accept-charset="UTF-8"  action="<?= base_url('dashboard/pesan/kirim_pesan_manual/'.$this->uri->segment(4));?>" >
                                    <div class="panel-body">
																			...
																			<br>
																			<textarea id="summernote" name="pesan_html"></textarea>
																			<br>
