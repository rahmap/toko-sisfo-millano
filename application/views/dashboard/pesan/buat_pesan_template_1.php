					...
					<div class="row">
						<div class="col-md-6 col-sm-offset-3 text-center">
							<div class="panel panel-default">
								<img class="img-responsive" src="<?= base_url('assets/email/example_product_1.PNG') ?>" alt="">
							</div>
						</div>
					</div>
				</div>
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Kirim Pesan</h3>
        <div class="row">
            <div class="panel panel-green">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default">
                                <form role="form" method="POST" accept-charset="UTF-8"
																			action="<?= base_url('dashboard/pesan/kirim_pesan_template1/'.$this->uri->segment(5)) ?>">
                                    <div class="panel-body">
																				<div class="row">
																					<div class="col-md-6">
																					...
																					<div class="col-md-6">
																						...
																						<div class="form-group">
																							<label>Title Tombol</label>
																							<input type="text" name="titleTombol" maxlength="20" required class="form-control">
																						</div>
																						<div class="form-group">
