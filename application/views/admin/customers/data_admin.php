												...
												foreach ($admin as $key) :  ?>
													<tr>
														...
														<?php if($key['is_active'] == 1){ ?>
															<a tabindex="-1" href="#" onclick="set_url1('<?= site_url('dashboard/admin/nonaktif_admin/' . encrypt_url($key['id_user']))  ?>')" 
															id="btnHapus" data-toggle="modal" data-target="#m_nonaktif">Nonaktifkan</a>
														<?php } else { ?>
															<a tabindex="-1" href="#" onclick="set_url2('<?= site_url('dashboard/admin/aktif_admin/' . encrypt_url($key['id_user']))  ?>')" 
															id="btnHapus" data-toggle="modal" data-target="#m_aktif">Aktifkan</a>
														<?php } ?>
															|
															<a tabindex="-1" href="#" onclick="set_url('<?= site_url('dashboard/admin/delete_admin/' . encrypt_url($key['id_user']))  ?>')" 
