...
<head>
	...
	<!-- Responsive Mobile-First Email Template by Konstantin Savchenko, 2015. Makasih ya bro template nya
	Saya modif sedikit templatenya
	https://github.com/rahmap/ -->
...
.footer a, .footer a:hover {
	...
	<!-- MESSAGE SUBJECT -->
	<title>Info Penerimaan Barang</title>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			color: #F0F0F0;" class="preheader">
				Informasi Penerimaan Barang Anda.
...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; line-height: 130%;
			...
			font-family: sans-serif;" class="header">
				Pesanan <span style="font-weight: bold;"><?= $id_orders ?></span>
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
			...
			src="https://i.ibb.co/yXDKjdd/open-package.png"
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			font-family: sans-serif;" class="paragraph">
				Halo <b><?= $nama ?></b> nomer Resi <b style="color: #E9703E;"><i><?= $nomerResi ?></i></b> kami lihat barangnya sudah sampai di kamu, jangan lupa konfirmasi penerimaan barang ya! Atau dalam <b style="color: #EB3F3F;">2 Hari</b> akan otomatis di konfirmasi oleh sistem.<br>
				Kamu dapat mengkonfirmasi sekarang dengan meng klik tombol dibawah ini.
		</td>
	</tr>
		...
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			href="#" target="_blank" style="text-decoration: none;">
				<table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;"><tr><td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: none; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
					...
					href="<?= base_url() ?>konfirmasi_penerimaan/<?= $id_trx ?>/<?= $email ?>">
						Konfirmasi Sekarang
					</a>
			</td></tr></table></a>
		</td>
		...
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;" class="list-item"><table align="center" border="0" cellspacing="0" cellpadding="0" style="width: inherit; margin: 0; padding: 0; border-collapse: collapse; border-spacing: 0;">
			...
			<tr>
				...
				border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;
					color: #000000;"
					src="https://i.ibb.co/TW5rmc9/kurir.png"
				...
				<td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
					...
					color: #000000;
					font-family: sans-serif;" class="paragraph">
						<b style="color: #333333;">Kurir</b><br/>
						Anda memilih kurir <b style="color: #1A98C9;"><?= $kurir ?></b> dengan service <b style="color: #1A98C9;">(<?= $service ?>)</b>.
				</td>
			...
			<tr>
				...
				border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;
					color: #000000;"
				  src="https://i.ibb.co/LNv2JsN/est.png"
				...
				<td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
					...
					color: #000000;
					font-family: sans-serif;" class="paragraph">
          <b style="color: #333333;">Estimasi</b><br/>
					<?= $est ?>.
				</td>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
				Punya pertanyaan? <a href="<?= base_url('contact') ?>" target="_blank" style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">Hubungi <?= APP_NAME ?></a>
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
			...
			font-family: sans-serif;" class="footer">
				...
				Email ini dikirim ke Anda karena anda membeli barang di toko kami, dan kami sudah mengisi nomer resi pengiriman untuk Anda.
