					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<form method="POST" action="<?= base_url('dashboard/master/actionUpdateOwner/'.$owner['id_user']) ?>">
											...
											<div class="form-group">
												<div class='input-group date' id='myDatepicker'>
													<input name="nama" required minlength="5"
																 value="<?= $owner['nama'] ?>" type="text" class="form-control" />
										...
										<div class='col-sm-6'>
											...
											<div class="form-group">
												<div class='input-group date' id='myDatepicker2'>
													<input type="email" readonly name="email" value="<?= $owner['email'] ?>" class="form-control" />
													<span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                              </span>
												</div>
                              ...
                              <span class="glyphicon glyphicon-calendar"></span>
										...
										<div class="col-md-12 text-center">
											<button type="submit" name="submit" class="btn btn-primary">Update Data Owner</button>
										</div>
									</div>
								</form>
