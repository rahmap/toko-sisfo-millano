					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<form method="POST" action="<?= base_url('dashboard/master/actionTambahOwner') ?>">

									<div class="row">
										<div class='col-sm-6'>
											<label for="OldPassword">Nama Owner  :</label>
                              ...
                              <span class="glyphicon glyphicon-calendar"></span>
										...
										<div class='col-sm-6'>
											<label for="OldPassword">Email Owner  :</label>
											<div class="form-group">
                              ...
                              <span class="glyphicon glyphicon-calendar"></span>
										...
										<div class='col-sm-6'>
											...
											<div class="form-group">
												<div class='input-group date' id='myDatepicker2'>
													<input type="text" minlength="8" required name="PasswordBaru" class="form-control" />
													<span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                              </span>
												</div>
										...
										<div class='col-sm-6'>
											...
											<div class="form-group">
												<div class='input-group date' id='myDatepicker2'>
													<input type="text" minlength="8" required name="fixPasswordBaru" class="form-control" />
													<span class="input-group-addon">
                              <span class="glyphicon glyphicon-calendar"></span>
                              </span>
												</div>
										...
										<div class="col-md-12 text-center">
											<button type="submit" name="submit" class="btn btn-primary">Tambahkan Owner</button>
										</div>
									</div>
								</form>
