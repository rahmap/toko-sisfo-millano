							...
							<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="x_panel">
										...
										<div class="x_content">
											...
											Menampilkan seluruh data admin pada <?= APP_NAME ?>.
											</p>
												...
												foreach ($admin as $key) :  ?>
													<tr>
														...
														<?php if($key['is_active'] == 1){ ?>
															<a tabindex="-1" href="#" onclick="set_url1('<?= site_url('dashboard/master/nonaktif_admin/' . encrypt_url($key['id_user']))  ?>')"
															id="btnHapus" data-toggle="modal" data-target="#m_nonaktif">Nonaktifkan</a>
														<?php } else { ?>
															<a tabindex="-1" href="#" onclick="set_url2('<?= site_url('dashboard/master/aktif_admin/' . encrypt_url($key['id_user']))  ?>')"
															id="btnHapus" data-toggle="modal" data-target="#m_aktif">Aktifkan</a>
														<?php } ?>
															|
															<a tabindex="-1" href="#" onclick="set_url('<?= site_url('dashboard/master/delete_admin/' . encrypt_url($key['id_user']))  ?>')"
															id="btnHapus" data-toggle="modal" data-target="#kt_modal_1">Hapus Admin</a>
															|
															<a href="<?= base_url('dashboard/master/update_admin/' . ($key['id_user']))  ?>" >Update Admin</a>
														</td>
													</tr>
												<?php endforeach; ?>
												</tbody>
